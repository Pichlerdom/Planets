...
#define __QTREE_SIZE 1000.0

#define PLANET_BLOCK_DIM 16
...
#define DEFAULT_PLANET_SPEED 10000

#define DEFAULT_PLANET_R 500
#define DEFAULT_PLANET_M_MAX 10000
#define DEFAULT_PLANET_M_MIN 3000
